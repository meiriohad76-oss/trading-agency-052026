...
@pytest.mark.parametrize(
    ...
    [
        ...
        (FreshnessDomain.TRADE_PRINTS, timedelta(minutes=19), FreshnessStatus.FRESH),
        (FreshnessDomain.TRADE_PRINTS, timedelta(minutes=30), FreshnessStatus.AGING),
        (FreshnessDomain.TRADE_PRINTS, timedelta(hours=1), FreshnessStatus.STALE),
