...
def _subscription_email_status_view(row: Mapping[str, object]) -> dict[str, object]:
    ...
    view.setdefault("linked_content_processing", 0)
    ...
    view.setdefault("current_action_label", "No article is being opened right now.")
    view.setdefault("current_article_url", "")
