...
- T01-T95 are archived under `tickets/done/`.
...
of the Command review queue, candidate detail review workspace, and review
progress summary, then follow-up tickets for confusing UI, threshold tuning, or
missing data sources found during that inspection.
