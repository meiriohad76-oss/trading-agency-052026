...
There are no active open ticket specs after T88.
...
clear any Live Config blockers, then run a current-date refresh with local
Alpaca credentials while watching the Command-page Data Loading panel. Keep the
