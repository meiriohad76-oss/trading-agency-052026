...
There are no active open ticket specs after T97.
...
review workspace, `/status/paper-review`, the paper-review smoke script, and
first-version testing checklist against the latest current-date paper cycle.
