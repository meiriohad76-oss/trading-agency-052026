...
def _event_row(
    ...
    *,
    ...
    return {
        ...
        "local_llm_article_status": record.local_llm_article_status,
        "local_llm_article_provider": record.local_llm_article_provider,
        "local_llm_article_model": record.local_llm_article_model,
        "local_llm_article_context_source": record.local_llm_article_context_source,
        "local_llm_article_direction": record.local_llm_article_direction,
        "local_llm_article_confidence": record.local_llm_article_confidence,
        "local_llm_article_tickers": list(record.local_llm_article_tickers),
        "local_llm_article_thesis": record.local_llm_article_thesis,
        "local_llm_article_key_points": list(record.local_llm_article_key_points),
        "local_llm_article_catalysts": list(record.local_llm_article_catalysts),
        "local_llm_article_risk_flags": list(record.local_llm_article_risk_flags),
        "local_llm_article_decision_use": record.local_llm_article_decision_use,
        "local_llm_article_signal_strength": record.local_llm_article_signal_strength,
        "local_llm_article_comparison": record.local_llm_article_comparison,
        "local_llm_article_error": record.local_llm_article_error,
        "local_llm_article_can_affect_trade_gates": (
            record.local_llm_article_can_affect_trade_gates
        ),
        "timestamp_observed": record.received_at.isoformat(),
        "timestamp_as_of": record.received_at.isoformat(),
        "freshness": freshness,
